...
function ClaimerRole() {
    BaseRole.apply(this, arguments);
}
ClaimerRole.super_ = BaseRole;
Object.setPrototypeOf(ClaimerRole.prototype, BaseRole.prototype);

ClaimerRole.prototype.run = function (claimer) {
...
ClaimerRole.prototype.getTargetRoomName = function (claimer) {
...
ClaimerRole.prototype.getBody = function (energy) {
